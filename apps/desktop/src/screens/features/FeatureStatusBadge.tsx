...
import type { FeatureStatus } from "@contextual/types";

const config: Record<FeatureStatus, { label: string; variant: "success" | "warning" | "danger" | "muted" | "default"; pulse?: boolean }> = {
